...
import static net.createyourideas.app.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static net.createyourideas.app.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static net.createyourideas.app.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import net.createyourideas.app.IntegrationTest;
import net.createyourideas.app.security.AuthoritiesConstants;
