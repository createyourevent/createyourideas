...
describe('Outgoings Management Component', () => {
  let comp: OutgoingsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OutgoingsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.outgoings[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
