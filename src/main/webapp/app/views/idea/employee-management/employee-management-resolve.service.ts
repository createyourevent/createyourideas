...
export class EmployeeManagementResolveService implements Resolve<IIdea> {
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<IIdea> | Observable<never> {
    ...
    if (id) {
      return this.generalService.queryIdeasByActiveTrueEagerEmployeesApplications(id).pipe(
